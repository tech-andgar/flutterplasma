...
class LayoutB extends StatelessWidget {
  const LayoutB({super.key, this.start = 0.0});
  final double start;
                        ...
                        child: ClipRect(
                          child: OverflowBox(
                            ...
                            child: Transform.translate(
                              offset:
                                  Offset(0, -value.get<double>(_P.pageScroll)),
                              child:
                                  _buildContentColumn(gap, constraints, value),
                            ),
                          ),
                        ),
                      ),
...
TimelineTween<_P> _createTween(double size, double gap) {
  ...
  final scroll2 =
      scroll1.addSubsequentScene(duration: 600.milliseconds).animate(
            _P.pageScroll,
            tween: 320.0
                .tweenTo(400.0)
                .curved(Curves.easeOut)
